...
#בדיקת העמודות על מנת לבחור נתונים מעניינים לאנליטיקות
...
for ax, feature in zip(axs, selected_features):
    ax.hist(df[feature], bins=20, color='m', edgecolor='black')
...
plt.title('Scatter Plot: Diabetic Patients - BMI vs Blood Glucose Levels', fontsize = 16)
plt.grid(True)
